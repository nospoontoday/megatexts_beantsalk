                    ...
                    <tbody>
                        ...
                        @foreach ($productSalesOrders as $index => $productSalesOrder)
                            <tr wire:key="products-group-{{$index}}">
                                ...
                                <td>
                                    <input
                                        list="productSalesOrders-{{$index}}-id" 
                                        wire:model.defer="productSalesOrders.{{$index}}.id"
                                        wire:key="productSalesOrders.{{$index}}.id"
                                        wire:change="setProduct({{$index}}, $event.target.value)"
                                    >
                                    <datalist id="productSalesOrders-{{$index}}-id">
            ...
            <div class="row pt-4">
                <div class="col-md-12">
                    <button class="btn btn-primary rounded-pill"
                        wire:click.prevent="addProduct">+ Add Another Online Database</button>
                </div>
            </div>
        </div>

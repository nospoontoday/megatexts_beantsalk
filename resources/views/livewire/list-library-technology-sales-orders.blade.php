                    ...
                    <tbody>
                        ...
                        @foreach ($productSalesOrders as $index => $productSalesOrder)
                            <tr wire:key="products-group-{{$index}}">
                                ...
                                <td>
                                    <input
                                        list="productSalesOrders-{{$index}}-item_code" 
                                        wire:model.defer="productSalesOrders.{{$index}}.item_code"
                                        wire:key="productSalesOrders.{{$index}}.item_code"
                                        wire:change="setProduct({{$index}}, $event.target.value)"
                                    >
                                    <datalist id="productSalesOrders-{{$index}}-item_code">
                                        <option value="">-- choose print book --</option>

                                        @foreach ($books as $book)
                                        <option 
                                            value="{{ $book->item_code }}">
                                        </option>
                                        @endforeach
                                    </datalist> 
                                </td>
                                <td>
                                    <input 
                                        type="text"
                                        name="developer"
                                        wire:model.defer="productSalesOrders.{{$index}}.developer"
                                        wire:key="productSalesOrders.{{$index}}.developer"
                                    />
                                </td>
                                <td>
                                    <input 
                                ...
                                <td>
                                    <input 
                                        ...
                                        wire:model.defer="productSalesOrders.{{$index}}.subscription_period"
                                        wire:key="productSalesOrders.{{$index}}.subscription_period"
                                    />
                                </td>
                                <td>
                                    <input 
            ...
            <div class="row pt-4">
                <div class="col-md-12">
                    <button class="btn btn-primary rounded-pill"
                        wire:click.prevent="addProduct">+ Add Another Library Technology</button>
                </div>
            </div>
        </div>

                            ...
                            <tr wire:key="products-group-{{$index}}">
                                ...
                                <td>
                                    <input 
                                        type="text"
                                        name="manufacturer"
                                        wire:model.defer="productSalesOrders.{{$index}}.manufacturer"
                                        wire:key="productSalesOrders.{{$index}}.manufacturer"
                                    />
                                </td>
                                <td>
                                    <input 
                                ...
                                <td>
                                    <input 
                                        type="text"
                                        name="dimension"
                                        wire:model.defer="productSalesOrders.{{$index}}.dimension"
                                        wire:key="productSalesOrders.{{$index}}.dimension"
                                    />
                                </td>
                                <td>
                                    <input 
            ...
            <div class="row pt-4">
                <div class="col-md-12">
                    <button class="btn btn-primary rounded-pill"
                        wire:click.prevent="addProduct">+ Add Another Library Fixture</button>
                </div>
            </div>
        </div>

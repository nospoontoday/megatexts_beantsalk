                            ...
                            <tr wire:key="products-group-{{$index}}">
                                ...
                                <td>
                                    <input 
                                        ...
                                        type="number"
                                        name="discount"
                                        wire:model.defer="productSalesOrders.{{$index}}.discount"
                                        wire:key="productSalesOrders.{{$index}}.discount"
                                        wire:change="setDiscount({{$index}}, $event.target.value)"
                                    />
                                </td>
                                <td>
                                    <input
            ...
            <div class="row pt-4">
                <div class="col-md-12">
                    <button class="btn btn-primary rounded-pill"
                        wire:click.prevent="addProduct">+ Add Another AV Material</button>
                </div>
            </div>
        </div>

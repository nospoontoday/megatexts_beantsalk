                    ...
                    <tbody>
                        ...
                        @foreach ($productSalesOrders as $index => $productSalesOrder)
                            <tr wire:key="products-group-{{$index}}">
                                ...
                                <td>
                                    <input
                                        list="productSalesOrders-{{$index}}-e_issn" 
                                        wire:model.defer="productSalesOrders.{{$index}}.e_issn"
                                        wire:key="productSalesOrders.{{$index}}.e_issn"
                                        wire:change="setProduct({{$index}}, $event.target.value)"
                                    >
                                    <datalist id="productSalesOrders-{{$index}}-e_issn">
                                ...
                                <td>
                                    <input 
                                        type="text"
                                        name="editor"
                                        wire:model.defer="productSalesOrders.{{$index}}.editor"
                                        wire:key="productSalesOrders.{{$index}}.editor"
                                    />
                                </td>
                                <td>
                                    <input 
                                ...
                                <td>
                                    <input 
                                        type="text"
                                        name="frequency"
                                        wire:model.defer="productSalesOrders.{{$index}}.frequency"
                                        wire:key="productSalesOrders.{{$index}}.frequency"
                                    />
                                </td>
                                <td>
                                    <input 

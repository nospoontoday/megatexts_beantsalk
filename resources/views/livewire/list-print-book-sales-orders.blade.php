                    ...
                    <tbody>
                        ...
                        @foreach ($productSalesOrders as $index => $productSalesOrder)
                            <tr wire:key="products-group-{{$index}}">
                                ...
                                <td>
                                    <input
                                        list="productSalesOrders-{{$index}}-isbn" 
                                        wire:model.defer="productSalesOrders.{{$index}}.isbn"
                                        wire:key="productSalesOrders.{{$index}}.isbn"
                                        wire:change="setProduct({{$index}}, $event.target.value)"
                                    >
                                    <datalist id="productSalesOrders-{{$index}}-isbn">

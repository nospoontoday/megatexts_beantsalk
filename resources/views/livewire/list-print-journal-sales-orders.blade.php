                    ...
                    <tbody>
                        ...
                        @foreach ($productSalesOrders as $index => $productSalesOrder)
                            <tr wire:key="products-group-{{$index}}">
                                ...
                                <td>
                                    <input
                                        list="productSalesOrders-{{$index}}-issn" 
                                        wire:model.defer="productSalesOrders.{{$index}}.issn"
                                        wire:key="productSalesOrders.{{$index}}.issn"
                                        wire:change="setProduct({{$index}}, $event.target.value)"
                                    >
                                    <datalist id="productSalesOrders-{{$index}}-issn">
                                        <option value="">-- choose print journal --</option>
                                ...
                                <td>
                                    <input 
                                        type="text"
                                        name="issue_number"
                                        wire:model.defer="productSalesOrders.{{$index}}.issue_number"
                                        wire:key="productSalesOrders.{{$index}}.issue_number"
                                    />
                                </td>
                                <td>
                                    <input 
            ...
            <div class="row pt-4">
                <div class="col-md-12">
                    <button class="btn btn-primary rounded-pill"
                        wire:click.prevent="addProduct">+ Add Another Print Journal</button>
                </div>
            </div>
        </div>

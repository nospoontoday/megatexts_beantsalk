...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Edit AV Materials</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::model($avMaterial, ['method' => 'PATCH','route' => ['print.av-materials.update', $avMaterial->id], 'enctype' => 'multipart/form-data']) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">Item Code</label>
                            {!! Form::text('item_code', null, array('placeholder' => 'Item Code','class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-2">

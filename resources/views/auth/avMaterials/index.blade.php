    ...
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                ...
                <div class="tab active"><a class="fw-bold text-primary">AV Materials</a></div>
                <div class="tab"><a href="{{url('print/library-fixtures')}}">Library Fixtures</a></div>
              </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                  <livewire:list-a-v-materials />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-content p-4 rounded-4">
      ...
      <div>
         <button type="button" class="btn-close float-end" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="mb-4">
            {!! Form::open(array('route' => 'print.av-material-import','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
            {!! Form::file('av_materials_import', null,array('class' => 'form-control bg-white')) !!}

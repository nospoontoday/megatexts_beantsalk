        ...
        <div class="col-md-12">
            ...
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::open(array('route' => 'print.library-fixtures.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            ...
                            {!! Form::text('manufacturer', null,array('class' => 'form-control bg-white', 'id' => 'manufacturer')) !!}
                        </div>
                        <div class="col-4">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            ...
                            {!! Form::text('dimension', null, array('class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-4">
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-4">
                            ...
                            {!! Form::number('vatable_sales', null, array('class' => 'form-control bg-white', 'step' => '0.1')) !!}
                        </div>
                    </div>
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">VAT</label>
                            {!! Form::number('vat', null, array('class' => 'form-control bg-white', 'step' => '0.1')) !!}
                        </div>
                        <div class="col-4">
...
<!-- libraryFixtures/create -->
<script defer>
    $(document).ready(function(){
        const field = document.getElementById('manufacturer');
        ...
        var manufacturers_url = {!! json_encode(url('/api/manufacturers')) !!}

        $.get(manufacturers_url, function(data, status){
            ac.setData(
                data
            );
        });

...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Add Lib-Tech</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    @endif
                    {!! Form::open(array('route' => 'digital.library-technologies.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            ...
                            {!! Form::text('developer', null,array('class' => 'form-control bg-white', 'id' => 'developer')) !!}
                        </div>
                        <div class="col-4">
...
<script defer>
    $(document).ready(function(){
        const field = document.getElementById('developer');
        ...
        var developers_url = {!! json_encode(url('/api/developers')) !!}

        $.get(developers_url, function(data, status){
            ac.setData(
                data
            );
        });

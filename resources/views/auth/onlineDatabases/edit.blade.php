...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Edit O-Databases</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::model($onlineDatabase, ['method' => 'PATCH','route' => ['digital.online-databases.update', $onlineDatabase->id], 'enctype' => 'multipart/form-data']) !!}
                    <div class="mb-2 row">
                        <div class="col-4">

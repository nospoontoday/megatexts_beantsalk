...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Edit E-Books</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::model($eBook, ['method' => 'PATCH','route' => ['digital.e-books.update', $eBook->id], 'enctype' => 'multipart/form-data']) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">E-ISBN</label>
                            {!! Form::text('e_isbn', null, array('placeholder' => 'E-ISBN','class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-2">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            ...
                            {!! Form::text('author[name]', null, array('placeholder' => 'Author','class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-4">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            ...
                            {!! Form::text('publication_year', null, array('placeholder' => 'Pub Yr','class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-4">
                    ...
                    <div class="float-end mt-4">
                          <a type="button" href="{{url('digital/e-books')}}" class="btn bg-light rounded-pill mx-4 px-4"> Cancel</a>

...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Add Print Books</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::open(array('route' => 'print.print-books.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">ISBN 13</label>
                            {!! Form::text('isbn_13', null,array('class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-2">

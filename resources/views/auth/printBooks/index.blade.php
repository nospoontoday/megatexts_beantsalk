...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Print Books</a></div>
    ...
    <div class="modal-content p-4 rounded-4">
      ...
      <div>
         <button type="button" class="btn-close float-end" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="mb-4">
            {!! Form::open(array('route' => 'print.print-book-import','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
            {!! Form::file('print_books_import', null,array('class' => 'form-control bg-white')) !!}

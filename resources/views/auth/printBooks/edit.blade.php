...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Edit Print Books</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::model($printBook, ['method' => 'PATCH','route' => ['print.print-books.update', $printBook->id], 'enctype' => 'multipart/form-data']) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">ISBN 13</label>
                            {!! Form::text('isbn_13', null, array('placeholder' => 'ISBN','class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-2">
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-4">
                            ...
                            {!! Form::text('discount', null, array('placeholder' => 'Discount','class' => 'form-control bg-white')) !!}
                        </div>
                    </div>
                    <div class="mb-2 row">
                        <div class="col-4">
                    ...
                    <div class="float-end mt-4">
                          <a type="button" href="{{url('print/print-books')}}" class="btn bg-light rounded-pill mx-4 px-4"> Cancel</a>

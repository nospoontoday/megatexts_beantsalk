...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Add E-Journals</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::open(array('route' => 'digital.e-journals.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">E-ISSN</label>
                            {!! Form::text('e_issn', null,array('class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-2">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            ...
                            {!! Form::text('editor', null,array('class' => 'form-control bg-white', 'id' => 'editor')) !!}
                        </div>
                        <div class="col-4">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            ...
                            {!! Form::text('frequency', null, array('class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-4">
...
<script defer>
    $(document).ready(function(){
        ...
        const field3 = document.getElementById('platform');
        const field4 = document.getElementById('access-model');
        ...
        const ac4 = new Autocomplete(field4, {
            data: [{label: "I'm a label", value: 42}],
            maximumItems: 5,
            threshold: 1,
            onSelectItem: ({label, value}) => {
        ...
        var editors_url = {!! json_encode(url('/api/editors')) !!}
        ...
        $.get(editors_url, function(data, status){
            ac.setData(
                data
            );
        });

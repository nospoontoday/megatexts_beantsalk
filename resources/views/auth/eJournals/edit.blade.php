...
<div class="container">
    <div class="row justify-content-center px-2">
        <div class="col-md-12">
            <div class="tabs">
                <div class="tab active"><a class="fw-bold text-primary" href="#">Edit E-Journals</a></div>
            </div>
            <div class="card pt-0">
                <div class="card-body p-4">
                    ...
                    {!! Form::model($eJournal, ['method' => 'PATCH','route' => ['digital.e-journals.update', $eJournal->id], 'enctype' => 'multipart/form-data']) !!}
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">E-ISSN</label>
                            {!! Form::text('e_issn', null, array('placeholder' => 'E-ISSN','class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-2">
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-4">
                            ...
                            {!! Form::text('publisher[name]', null, array('placeholder' => 'Publisher','class' => 'form-control  bg-white')) !!}
                        </div>
                    </div>
                    <div class="mb-2 row">
                        <div class="col-8">
                    ...
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">Frequency</label>
                            {!! Form::text('frequency', null, array('placeholder' => 'Frequency','class' => 'form-control  bg-white')) !!}
                        </div>
                        <div class="col-4">
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-4">
                            ...
                            {!! Form::text('platform[name]', null, array('placeholder' => 'Platform','class' => 'form-control  bg-white')) !!}
                        </div>
                    </div>
                    <div class="mb-2 row">
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">Access Model</label>
                            {!! Form::text('accessModel[name]', null, array('placeholder' => 'Access Model','class' => 'form-control bg-white')) !!}
                        </div>
                        <div class="col-4">
                            <label class="form-label mb-0 fw-bold">Subscription Period</label>
                            {!! Form::text('subscription_period', null, array('placeholder' => 'Subscription Period','class' => 'form-control bg-white')) !!}
                        </div>
                    </div>
                    <div class="mb-2 row">
                        <div class="col-4">
                    ...
                    <div class="float-end mt-4">
                          <a type="button" href="{{url('digital/e-journals')}}" class="btn bg-light rounded-pill mx-4 px-4"> Cancel</a>
